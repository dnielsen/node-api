      ...
      <NavContent className='pull-right'>
        <Nav className='hidden-xs'>
          ...
          <NavItem dropdown>
            ...
            <Menu alignRight noTimer bsStyle='theme' ref='flag-menu' id='flag-menu' className='double-width' onItemSelect={this.changeFlag}>
              <MenuItem header>
                ...
                <Grid>
                  <Row>
                    ...
                    <Col xs={10} className='notification-container' collapseLeft collapseRight>
                      ...
                      <div className='message-details fg-darkgray50'>
            ...
            <Menu alignRight noTimer id='rss-menu' ref='rss-menu' className='double-width' alwaysInactive>
              ...
              <MenuItem href='#'>
                <Grid>
                  <Row>
                    <Col xs={2}>
                      <Icon className='fg-darkgray50' bundle='fontello' glyph='star' />
                    </Col>
              ...
              <MenuItem href='#'>
                <Grid>
                  <Row>
                    <Col xs={2}>
                      <Icon className='fg-darkgray50' bundle='fontello' glyph='chat-1' />
                    </Col>
                    <Col xs={10} collapseLeft className='notification-container' style={{width: 265}}>
                      <div className='time'>
              ...
              <MenuItem href='#'>
                <Grid>
                  <Row>
                    <Col xs={2}>
                      <Icon className='fg-darkgray50' bundle='fontello' glyph='fork' />
                    </Col>
                    <Col xs={10} collapseLeft className='notification-container' style={{width: 265}}>
                      <div className='time'>
              ...
              <MenuItem href='#'>
                <Grid>
                  <Row>
                    <Col xs={2}>
                      <Icon className='fg-darkgray50' bundle='fontello' glyph='attention-alt-1' />
                    </Col>
                    <Col xs={10} collapseLeft className='notification-container' style={{width: 265}}>
                      <div className='time'>
