    ...
    return (
      <Container id='homepage-container'>
        ...
        <Hero>
          ...
          <p className='text-center'>
            {"Mozilla L20n is a developer friendly framework that places languages in the localizer's hand to create better translations. Rubix provides React component bindings to make it easier to work."}
          </p>
        </Hero>
        <Hero>
